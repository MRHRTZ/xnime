...
<body>
    ...
    <div class="breadcrumbs">
        <p class="breadcrumbs__text"><a href="./" class="breadcrumbs__link">Home</a> <span class="breadcrumbs__arrow">»</span> Resultado para "Tower Of God"</p>
    </div>
    <main class="main">
        <div class="wrapper mt--none">
                ...
                <div class="aside__box">
                        ...
                        <nav class="filter__nav">
                            <ul class="filter-nav__list">
                                <li class="filter-nav__item">
                                    <p><a href="./search-result" class="filter-nav__link">ANIME</a> <span class="text--active">(1)</p>
                                </li>
                                <li class="filter-nav__item">
                                    <p>FILME</a>
                                </li>
                    ...
                    <div class="filter__item">
                        ...
                        <nav class="filter__nav">
                            <ul class="filter-nav__list">
                                <li class="filter-nav__item">
                                    <p><a href="./search-result" class="filter-nav__link">LEGENDADO</a> <span class="text--active">(1)</span></p>
                                </li>
                                <li class="filter-nav__item">
                                    <p>DUBLADO</p>
                                </li>
            ...
            <section class="section anime-list">
                <h1 class="section__title">#PESQUISA</h1>
                <div class="search-box">
                    <form action="./search-result" class="search-box__form">
                        <input type="text" class="search-box__input" value="Tower Of God">
                ...
                <div class="anime-list__item">
                    <div class="anime-list__cover">
                        <a href="./single-anime">
                            <img src="../animesXP/assets/img/covers/tower-of-god.jpg" class="anime-list__img">
                        </a>
                    </div>
