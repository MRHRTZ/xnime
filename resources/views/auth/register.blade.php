...
<main class="main">
    <section class="section contact">
        ...
        <div class="contact-box">
            <form action="{{ route('register_process') }}" method="POST" class="contact-box__form">
                @csrf
                ...
                <div class="form-control">
                    ...
                    <input type="password" name="password_confirmation" class="form-control__input" placeholder="Konfirmasi password ..." required>
                </div>
